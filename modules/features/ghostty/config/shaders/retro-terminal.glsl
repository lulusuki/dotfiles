...
const float BRIGHT_BOOST = 1.2;          // Brightness multiplier for bright pixels (default: 1.2)
...
const float COLOR_GLOW = 0.4;            // Color bleeding intensity (default: 0.3)

// Scanline Settings
const float SCANLINE_INTENSITY = 1.0;    // Overall intensity of scanlines (default: 1.0)
const float SCANLINE_DENSITY = 0.35;     // Density/thickness of scanlines (default: 0.25)
